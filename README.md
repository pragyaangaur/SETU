...
Four gaps in this project can only be closed by people outside it, and requests for all of them are drafted and held privately rather than in this repository.
...
4. **Aditya-L1 solar wind data access and latency.** India has its own monitor at the first Lagrange point, and a warning system for the Indian grid should be reading it.
